...
public class ModWeaponItems {
    ...
    public static Item Elucidator = register("elucidator", new SwordItem(MetallToolMaterial.INSTANCE,
            new Item.Properties().fireResistant().rarity(Rarity.EPIC).attributes(SwordItem.createAttributes(MetallToolMaterial.INSTANCE, 10, -2.4F))));

    public static Item Dark_Repulsor = register("dark_repulsor", new SwordItem(CrystalliteToolMaterial.INSTANCE,
            new Item.Properties().fireResistant().rarity(Rarity.EPIC).attributes(SwordItem.createAttributes(CrystalliteToolMaterial.INSTANCE, 6, -2.4F))));
    ...
    public static Item Zoringen_Hammer = register("zoringen_hammer", new MaceItem(new Item.Properties()
            .fireResistant().rarity(Rarity.RARE).attributes(MaceItem.createAttributes())));
